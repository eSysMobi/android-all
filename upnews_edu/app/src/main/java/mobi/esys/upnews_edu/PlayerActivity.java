...
import mobi.esys.upnews_edu.cbr.GetCurrencies;
...
import mobi.esys.upnews_edu.download.DownloadState;
import mobi.esys.upnews_edu.download.FacebookVideoDownloadHelper;
import mobi.esys.upnews_edu.eventbus.EventCurrency;
...
import mobi.esys.upnews_edu.facebook.FacebookVideoItem;
import mobi.esys.upnews_edu.filesystem.FileSystemHelper;
import mobi.esys.upnews_edu.instagram.CheckInstaTagTask;
import mobi.esys.upnews_edu.instagram.InstagramDownloader;
import mobi.esys.upnews_edu.instagram.InstagramItem;
import mobi.esys.upnews_edu.net.NetMonitor;
import mobi.esys.upnews_edu.tasks.GetLocationTask;
import mobi.esys.upnews_edu.twitter.TwitterHelper;
...
public class PlayerActivity extends Activity implements YahooWeatherInfoListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        instagramRunnable = new Runnable() {
            ...
            public void run() {
                try {
                    CheckInstaTagTask checkInstaTagTask = new CheckInstaTagTask(hashTag, mApp, true);
