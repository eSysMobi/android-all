...
public final class TimeConsts {
    public static final int APP_START_DELAY = 30000;
    public static final int WEATHER_REQUEST_TIMEOUT = 5000;
    //1 hour
    public static final int WEATHER_AND_CURR_REFRESH_INTERVAL = 3600 * 1000;
    //15 minutes
    public static final int TWITTER_AND_INSTAGRAM_REFRESH_INTERVAL = 900 * 1000;
    //5 minutes
